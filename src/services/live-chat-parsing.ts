...
/**
 * Parses one line of a live chat replay into the messages it carries.
 *
 * A line may yield zero messages (a heartbeat, an action with no chat item, or a renderer this app
 ...
 * heartbeat into a warning.
 */
export function parseLiveChatLine(line: string): LiveChatMessageItem[] {
