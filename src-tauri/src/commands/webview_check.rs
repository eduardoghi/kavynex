...
//!
//! **What it does not cover, stated plainly.** The plugin grants that cannot be exercised without
//! a human or a side effect. `dialog:allow-open`/`allow-save` (would open a file picker),
