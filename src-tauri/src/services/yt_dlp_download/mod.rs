...
// The pure request validation, argument-vector construction and outcome classification live in
// the `command` submodule so they stay unit-testable apart from the async orchestration below.
mod command;
use command::{
