...
// `ddl` submodule so the migrations below read as steps rather than SQL text. Glob-imported
// because the migrations reference many of these constants by name.
mod ddl;
use ddl::*;
