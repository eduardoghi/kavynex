...
impl AppErrorCode {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::TooManyConcurrentYtDlpRuns => "TOO_MANY_CONCURRENT_YT_DLP_RUNS",
            ...
            Self::YtDlpCommentsIncomplete => "YT_DLP_COMMENTS_INCOMPLETE",
